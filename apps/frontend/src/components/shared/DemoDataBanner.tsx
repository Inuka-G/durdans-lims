...
export default function DemoDataBanner({ note }: { note?: string }) {
    return (
        <div
            role="note"
            className="mb-4 flex items-start gap-2 rounded-md border border-status-pending-edge bg-status-pending-bg px-4 py-2.5 text-[13px] font-medium text-status-pending-fg"
        >
