        ...
        <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm mb-6">
                ...
                <div className="mt-4 flex items-center gap-2 text-primary">
                    ...
                    <p className="text-sm font-medium italic">Always verify existing patients before registering a new one.</p>
                </div>
            </div>
                ...
                <div className="overflow-x-auto">
                    <table className="w-full border-collapse">
                        ...
                        <tbody>
                            {loading ? (
                                <tr>
                                    <td colSpan={6} className="px-6 py-4 whitespace-nowrap text-sm text-center text-slate-500">
                                        Searching...
                                    </td>
                                </tr>
                            ) : patients.length === 0 ? (
